...
const COLOUR_OPTIONS = ['#E8593C', '#2E9E6B', '#D4853A', '#7B5CC3', '#3B8BD4', '#D4537E', '#1D9E75', '#BA7517'];
...
export default function CategoriesScreen() {
  ...
  const deleteCategory = async (catId: number) => {
    Alert.alert('Delete Category', 'Are you sure? Activities using this category will keep their current category reference.', [
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      {showForm ? (
        <View style={styles.formCard}>
          ...
          <FormField label="Name" value={name} onChangeText={setName} placeholder="e.g. Water Sports" />
          ...
          <View style={styles.optionRow}>
            {COLOUR_OPTIONS.map((c) => (
              <Pressable
                key={c}
                style={[styles.colourSwatch, { backgroundColor: c }, selectedColour === c && styles.swatchSelected]}
